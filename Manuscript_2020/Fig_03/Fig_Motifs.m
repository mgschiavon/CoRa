%% Figure 3. CoRa provides a unifying framework to compare different feedback control motifs
%   Gómez-Schiavon & El-Samad
%   July 2020
clear

%% All panels
motifs = {'ATFv1','ATFv2','FADv1','FADv2','FDPv1','FDPv2','BNFv1','BNFv2','FFLv1','BMFv1','BMFv2'};
for m = 1:length(motifs)
    load(cat(2,'DATA_DYms_',motifs{m},'_Fig3_mY_mY.mat'))
    ...
    hold on;
        ...
        print(gcf,cat(2,'RAW_Fig3_',motifs{m}),'-dpng','-r300')
end